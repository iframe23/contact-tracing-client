        ...
        <router-link to="/schedules">
          <b-card no-body class="bg-danger">
            <b-card-body class="pb-0">
              <div class="row">
                <div class="col-8">
                  <div><h4 class="mb-0">{{unfinalizedSchedules}}</h4><p>Unfinalized Schedules</p></div>
                </div>
                <div class="col-4">
...
export default {
  ...
  methods:{
    ...mapActions(['fetchLoggedUser','fetchSubjectLoadsPerDays','fetchStudentsInEachSubjectLoads','fetchDepartmentPopulation','fetchDepartmentInstructors','fetchSubjectLoadsNum','fetchUnfinalizedSchedules','fetchCoursesCollections', 'fetchMonthlyCollection', 'fetchNewStudents', 'fetchUsedProspectuses', 'fetchActiveCourses','fetchOldStudents'])
  },
  computed: {
    ...mapGetters(['loggedUser','subjectLoadsPerDays','studentsInEachSubjectLoads','departmentPopulation','departmentInstructors','subjectLoadsNum','unfinalizedSchedules','coursesCollections', 'monthlyCollection', 'newStudents', 'oldStudents', 'usedProspectuses', 'activeCourses'])
  },
  async mounted(){
