<template>
  <div class="pt-4 container-fluid bg-white thead-primary">
    <div class="row">
        ...
        <div class="col-md-4 pr-md-5">
            ...
            <div @mouseenter="hovered = true" @mouseleave="hovered = false" class="position-relative">
                ...
                <div class="bg-info rounded pt-4 pb-4 mb-4" v-if="user.qr_code == ''">
                    <qrcode-vue class="d-flex justify-content-center" :value="user.user_id" size="150"></qrcode-vue>
                </div>
            </div>
        </div>
        <div class="col-md-8">
